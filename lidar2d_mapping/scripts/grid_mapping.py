...
class GridMappingROS:
    def __init__(self):
        ...
        self.map_center_x         = rospy.get_param('~mapping/map_center_x', -1.0)
        self.map_center_y         = rospy.get_param('~mapping/map_center_y', -1.0)
        self.map_size_x           = rospy.get_param('~mapping/map_size_x', 20.0)
        self.map_size_y           = rospy.get_param('~mapping/map_size_y', 20.0)
